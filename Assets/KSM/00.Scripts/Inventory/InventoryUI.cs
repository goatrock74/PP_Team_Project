...
namespace KSM._00.Scripts.Items
{
    ...
    public class InventoryUI : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // 제작창이 열려 있거나 "제작중" 연출이 도는 동안엔 인벤토리 키를 무시한다.
            // 두 창이 겹치면 드래그 앤 드롭이 꼬이고, 연출 중에 재료를 옮길 수도 있다
            if (KSM._00.Scripts.Crafting.CraftingUI.IsOpen) return;
            if (KSM._00.Scripts.Crafting.CraftingOverlay.AnyPlaying) return;
